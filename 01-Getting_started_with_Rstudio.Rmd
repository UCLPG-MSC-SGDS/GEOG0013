...
6. Lastly, we will learn the following techniques: (a.) generating theoretical distribution particularly the **Normal Distribution**; (b.) standardizing continuous data using z-scores; and (c.) making probability predictions.
...
# Part 4: Introduction to Distributions {-}

```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('images/general/getting_started/Under_Construction.png', error = FALSE) 
```
